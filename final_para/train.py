"""
This script is used to fine-tune (hugging-face's pretrained) T5 Language Model to generate paraphrases, using Quora's Similar Questions Dataset.

Used pytorch_lightning for fast proto-typing
Read more here https://github.com/PyTorchLightning/pytorch-lightning

TIP: 
Use a small epoch, lest you over-fit on the data set.
"""
import argparse
import glob
import os
